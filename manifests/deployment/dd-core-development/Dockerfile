...
RUN underpost clone underpostnet/engine-core

RUN sudo mv ./engine-core ./engine

WORKDIR /home/dd/engine

RUN underpost clone underpostnet/engine-core-private
...
CMD [ "npm", "run", "dev-img", "dd-core", "deploy" ]
