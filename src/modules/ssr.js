...
const renderView = dataView => {
    ...
    let jsClientCore = `(function(){
        ...
        const API_URL = '${process.env.NODE_ENV == 'development' || process.env.NODE_ENV == 'test-dev' || process.env.NODE_ENV == 'ipfs-dev' || process.env.NODE_ENV == 'cyberia-dev' ? process.env.API_URL + ':' + process.env.PORT : process.env.API_URL}';
    ...
    <html dir='${viewMetaData.dir}' lang='${viewMetaData.lang}'>
        ...
        <body>                  
            <script>
                ${process.env.NODE_ENV == 'development' || process.env.NODE_ENV == 'test-dev' || process.env.NODE_ENV == 'ipfs-dev' || process.env.NODE_ENV == 'cyberia-dev' ? jsClientCore : UglifyJS.minify(jsClientCore).code}
            </script>
        </body>
    </html>
