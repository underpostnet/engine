...
class CyberiaActionController {
  static post = async (req, res, options) => {
    try {
      const result = await CyberiaActionService.post(req, res, options);
  ...
  static get = async (req, res, options) => {
    try {
      ...
      const result = await CyberiaActionService.get(
  ...
  static delete = async (req, res, options) => {
    try {
      const result = await CyberiaActionService.delete(req, res, options);
      return res.status(200).json({
        status: 'success',
        data: result,
      });
