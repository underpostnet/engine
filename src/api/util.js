...
const buildURL = (viewMetaData, subDomain) => {
    ...
    if (process.env.SSL == 'true')
        return `https://${subDomain ? subDomain + '.' : viewMetaData.subDomain ? viewMetaData.subDomain + '.' : ''}${viewMetaData.host}${viewMetaData.proxyPath ? viewMetaData.proxyPath : ''}`;
    return `http://${subDomain ? subDomain + '.' : viewMetaData.subDomain ? viewMetaData.subDomain + '.' : ''}${viewMetaData.host}${viewMetaData.proxyPath ? viewMetaData.proxyPath : ''}`;
};
