...
window.Routes = RoutesCecinasmarcelina;

const RouterCecinasmarcelina = () => {
  return { Routes: RoutesCecinasmarcelina };
};

export { RoutesCecinasmarcelina, RouterCecinasmarcelina, BannerAppTemplate };
