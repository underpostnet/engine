...
const Menu = {
  ...
  Render: async function () {
    ...
    EventsUI.onClick(`.main-btn-settings`, async () => {
      ...
      await Modal.Render({
        ...
        route: 'settings',
        barConfig,
        title: this.renderViewTile({ img: 'settings.png', text: Translate.Render('settings') }),
    ...
    EventsUI.onClick(`.main-btn-bag`, async () => {
      ...
      await Modal.Render({
        ...
        route: 'bag',
        barConfig,
        title: this.renderViewTile({ img: 'bag.png', text: Translate.Render('bag') }),
    ...
    EventsUI.onClick(`.main-btn-colors`, async () => {
      ...
      await Modal.Render({
        ...
        route: 'colors',
        barConfig,
        title: this.renderViewTile({ img: 'pallet-colors.png', text: Translate.Render('pallet-colors') }),
    ...
    EventsUI.onClick(`.main-btn-biome`, async () => {
      ...
      await Modal.Render({
        ...
        route: 'biome',
        barConfig,
        title: this.renderViewTile({ img: 'engine.png', text: 'Biome engine' }),
    ...
    EventsUI.onClick(`.main-btn-tile`, async () => {
      ...
      await Modal.Render({
        ...
        route: 'tile',
        barConfig,
        title: this.renderViewTile({ img: 'engine.png', text: 'Tile engine' }),
    ...
    EventsUI.onClick(`.main-btn-3d`, async () => {
      ...
      await Modal.Render({
        ...
        route: '3d',
        barConfig,
        title: this.renderViewTile({ img: 'engine.png', text: '3d Engine' }),
        html: async () =>
    ...
    EventsUI.onClick(`.main-btn-world`, async () => {
      ...
      await Modal.Render({
        ...
        route: 'world',
        barConfig,
        title: this.renderViewTile({ img: 'engine.png', text: 'World Engine' }),
    ...
    EventsUI.onClick(`.main-btn-chat`, async () => {
      ...
      await Modal.Render({
        ...
        route: 'chat',
        barConfig,
        title: this.renderViewTile({ img: 'chat.png', text: 'Chat' }),
  ...
  renderViewTile: ({ img, text }) => html`<img
