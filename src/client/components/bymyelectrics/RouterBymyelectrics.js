...
const BannerAppTemplate = html`Bymyelectrics`;

class RouterBymyelectrics {
  static routes() {
    return {
      '/': {
        title: 'Home',
  ...
  static instance() {
    return { Routes: RouterBymyelectrics.routes };
  }
}

export { RouterBymyelectrics, BannerAppTemplate };
