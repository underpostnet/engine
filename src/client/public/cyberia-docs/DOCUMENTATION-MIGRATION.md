...
| --------------------- | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Umbrella product**  | **Underpost Platform**                                 | Infra · toolchain · application platform. Manages base ERP/CRM-style PWA applications and the Cyberia MMO extension. Spans bare metal, K8s/LXD/K3s/kubeadm, CI/CD, GitHub OSS flow, static + PWA + Workbox delivery, Cloudinary-backed assets, Underpost CLI v3.2.9. |
...
| -------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [UNDERPOST-PLATFORM.md](UNDERPOST-PLATFORM.md)           | **Done**           | Umbrella product doc; canonical introduction to platform scope and CLI v3.2.9 surface.                                                     |
...
| [CYBERIA-CLI.md](CYBERIA-CLI.md)                         | **Pending review** | Frame as Cyberia-specific extensions to Underpost CLI v3.2.9; remove duplicated coverage; cross-link to `UNDERPOST-PLATFORM.md`.           |
...
These are platform-level reference docs. They already cover Underpost CLI v3.2.9 capabilities and are good as a foundation. Action items:

| Document                                                                                                                                                                                                                                                                                                                                                      | Action                                                                                                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Getting started.md`                                                                                                                                                                                                                                                                                                                                          | Lead with **Underpost Platform** framing; note that Cyberia is an MMO extension on top.                                                                                                                      |
| `Command Line Interface.md`                                                                                                                                                                                                                                                                                                                                   | Confirm CLI v3.2.9 coverage list matches `UNDERPOST-PLATFORM.md` § "Underpost CLI v3.2.9 — command surface".                                                                                                 |
