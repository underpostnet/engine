...
- See [Main Cluster Lifecycle Commands](./Main%20cluster%20lifecycle%20commands.md) for cluster management
- See [DB and Backup Management Guide](./DB%20and%20Backup%20management%20Guide.md) for database operations
- Check `node bin deploy --help` for complete options list
